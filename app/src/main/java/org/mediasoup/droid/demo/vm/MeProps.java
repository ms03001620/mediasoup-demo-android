...
public class MeProps extends PeerViewProps {
    ...
    public MeProps(@NonNull Application application, @NonNull RoomStore roomStore) {
        ...
        mStateComposer.addOnPropertyChangedCallback(new Observable.OnPropertyChangedCallback() {
            ...
            public void onPropertyChanged(Observable sender, int propertyId) {
                ...
                mAudioRtpParameters.set(audioProducer != null ? audioProducer.getRtpParameters() : null);
                mVideoRtpParameters.set(videoProducer != null ? videoProducer.getRtpParameters() : null);
                ...
                } else if (videoPW != null && !Producers.ProducersWrapper.TYPE_SHARE.equals(videoPW.getType())) {
                ...
                } else if (videoPW != null && !Producers.ProducersWrapper.TYPE_SHARE.equals(videoPW.getType()) && me.isCanChangeCam()) {
    ...
    public void connect(LifecycleOwner owner) {
        ...
        getRoomStore().getRoomInfo().observe(owner, roomInfo -> {
            ...
            mConnected.set(RoomClient.ConnectionState.CONNECTED.equals(roomInfo.getConnectionState()));
        });
